...
def generate_launch_description():
    ...
    declare_coco_detector = DeclareLaunchArgument(
        "coco_detector", default_value="true", description="Launch COCO detector"
    )
    ...
    coco_detector_node = Node(
        ...
        remappings=[
            ('/camera/image_raw', '/d455/image'),
        ],
        condition=IfCondition(LaunchConfiguration("coco_detector")),
    )
